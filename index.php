...
include("common/vars.php");//$stim = time()-$tim; $tim =time(); echo "<br>after include vars $stim";
include("config.php");//$stim = time()-$tim; $tim =time(); echo "<br>after include config $stim";
include('lib/browser/Browser.php');//$stim = time()-$tim; $tim =time(); echo "<br>after include  browser $stim";
//$stim = time()-$tim; $tim =time(); echo "<br>after include $stim";
//include('common/daftarobj.php');

$browser = new Browser();
//if( $browser->getBrowser() == Browser::BROWSER_FIREFOX || $browser->getBrowser() == Browser::BROWSER_CHROME){
...
if (CekLogin ()) {
    ...
    switch ($Pg) {
        ...
        case "05":
            ...
            break;
        case "06":if (empty($disModul06)) {
                include("pages/base.php");
                include("pages/06/selector.php");
            }break;
        case "07":if (empty($disModul07)) {
                include("pages/base.php");
                include("pages/07/selector.php");
            }break;
        case "08":if (empty($disModul08)) {
                include("pages/base.php");
                include("pages/08/selector.php");
            }break;
        case "09":if (empty($disModul09)) {
                include("pages/base.php");
                include("pages/09/selector.php");
            }break;
        case "10":if (empty($disModul10)) {
                include("pages/base.php");
                include("pages/10/selector.php");
            }break;
        case "11":if (empty($disModul11)) {
                include("pages/base.php");
                include("pages/11/selector.php");
            }break;
        case "12":if (empty($disModul12)) {
                include("pages/base.php");
                include("pages/12/selector.php");
            }break;
        case "13":if (empty($disModul13)) {
                include("pages/base.php");
                include("pages/13/selector.php");
            }break;
        case "ref":if (empty($disModulref)) {
                include("pages/base.php");
        ...
        case "Menu":include("pages/base.php");
            ...
            break;
		default:{
			//header("Location: pages.php?Pg=pendaftaran");
		}
...
/* * ****** create main->show ****** */
$Main->Show = $Main->Base;
$Main->Show = preg_replace("<!--JUDUL-->", $Main->Judul, $Main->Show);
$Main->Show = preg_replace("<!--NAVATAS-->", $Main->NavAtas, $Main->Show);
$Main->Show = preg_replace("<!--NAVBAWAH-->", $Main->NavBawah, $Main->Show);
$Main->Show = preg_replace("<!--COPYRIGHT-->", $Main->CopyRight, $Main->Show);
$Main->Show = preg_replace("<!--ISI-->", $Main->Isi, $Main->Show);
