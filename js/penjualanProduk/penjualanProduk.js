var penjualanProduk = new DaftarObj2({
  prefix: "penjualanProduk",
  url: "pages.php?Pg=penjualanProduk",
  formName: "penjualanProdukForm",
  penjualanProduk_form: "0", //default js penjualanProduk
  loading: function() {
    //alert('loading');
    this.topBarRender();
    this.filterRender();
  ...
  Baru: function() {
    ...
    if (err == "") {
      ...
      if (me.penjualanProduk_form == 0) {
        //baru dari penjualanProduk
